			...
			<div>
				<div style={gridStyle}>
					...
					<div style={rowStyle}>
						...
						<Button variant="light" color="danger">Light Danger</Button>
					</div>
				...
				<div style={gridStyle}>
					...
					<div style={rowStyle}>
						<div></div>
						<Button disabled variant="solid" color="primary">Solid Primary</Button>
						<Button disabled variant="solid" color="secondary">Solid Secondary</Button>
						<Button disabled variant="solid" color="success">Solid Success</Button>
						<Button disabled variant="solid" color="danger">Solid Danger</Button>
					</div>

					<div style={rowStyle}>
						<div></div>
						<Button disabled variant="light" color="primary">Light Primary</Button>
						<Button disabled variant="light" color="secondary">Light Secondary</Button>
						<Button disabled variant="light" color="success">Light Success</Button>
						<Button disabled variant="light" color="danger">Light Danger</Button>
					</div>

					<div style={rowStyle}>
						<div></div>
						<Button disabled variant="ghost" color="primary">Ghost Primary</Button>
						<Button disabled variant="ghost" color="secondary">Ghost Secondary</Button>
						<Button disabled variant="ghost" color="success">Ghost Success</Button>
						<Button disabled variant="ghost" color="danger">Ghost Danger</Button>
					</div>
				</div>
			</div>
